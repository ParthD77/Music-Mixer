...
public class MainMenu extends JFrame implements ActionListener{
	...
	public MainMenu() {
		...
		width = 900;
		height = 650;
		background = "Images/Themes/violetTheme.png";
